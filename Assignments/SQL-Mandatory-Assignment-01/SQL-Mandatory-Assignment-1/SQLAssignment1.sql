...
from 
Salesman1 t1 inner join Salesman2 t2 
on t1.SalesmanId = t2.SalesmanId;

--Diffrent saleman
SELECT t1.SalesmanId , t2.SalesmanId
FROM Salesman1 t1
LEFT JOIN Salesman2 t2 ON t1.SalesmanId = t2.SalesmanId
WHERE t2.SalesmanId IS NULL
UNION
SELECT t2.SalesmanId FROM Salesman2 t2
LEFT JOIN 
Salesman1 t1 ON t1.SalesmanId = t2.SalesmanId
WHERE t1.SalesmanId IS NULL;
...
FROM 
    Orders o
JOIN
    Salesman s ON s.SalesmanId = o.SalesmanId
JOIN 
    Customer c ON c.SalesmanId = s.SalesmanId
where c.PurchaseAmount > 500 and PurchaseAmount <1500
